...
<body>
    ...
    <div class="main">
        <div class="namabajumuslim">
            <img src="gambar/Abaya.jpg" alt="">
            <p>Abaya</p>
            <p>IDR. 250,000,-</p>
        </div>
        <div class="namabajumuslim">
            <img src="gambar/Gamis 2022.jpg">
            <p>Gamis Reanata</p>
            <p>IDR. 220.000,</p>
        </div>
        <div class="namabajumuslim">
            <img src="gambar/Clarissa.jpg">
            <p>Gamis Clarissa</p>
            <p>IDR. 200.000,</p>
        </div>
        <div class="namabajumuslim">
            <img src="gambar/Baju Kurung Moden Style.jpg">
    ...
    <div id="About">
        <div class="wrapper">
            <section id="About">
                <p ><img src="gambar/Darniah.jpg" style="float:left;"/></p>
                <div class="footer">
